...
query_tgi = """
### You will be a helpful, respectful, and honest assistant whose goal is to help users answer their questions. 
### Article: In a world where technology has advanced beyond our wildest dreams, humanity stands on the brink of a new era. The year is 2050, and artificial intelligence has become an integral part of everyday life. Autonomous vehicles zip through the streets, drones deliver packages with pinpoint accuracy, and smart homes anticipate every need of their inhabitants. But with these advancements come new challenges and ethical dilemmas. As society grapples with the implications of AI, questions about privacy, security, and the nature of consciousness itself come to the forefront.\n Amidst this backdrop, a new breakthrough in quantum computing promises to revolutionize the field even further. Scientists have developed a quantum processor capable of performing calculations at speeds previously thought impossible. This leap in technology opens the door to solving problems that have long stumped researchers, from predicting climate change patterns with unprecedented accuracy to unraveling the mysteries of the human genome. However, the power of this new technology also raises concerns about its potential misuse. Governments and corporations race to secure their own quantum capabilities, sparking a new kind of arms race. Meanwhile, a group of rogue programmers, known as the Shadow Collective, seeks to exploit the technology for their own ends.\n As tensions rise, a young scientist named Dr. Evelyn Zhang finds herself at the center of this unfolding drama. She has discovered a way to harness quantum computing to create a true artificial general intelligence (AGI), a machine capable of independent thought and reasoning. Dr. Zhang's creation, named Athena, possesses the potential to either save humanity from its own worst impulses or to become the ultimate instrument of control. As she navigates the treacherous waters of corporate espionage, government intrigue, and ethical quandaries, Dr. Zhang must decide the fate of her creation and, with it, the future of humanity. Will Athena be a benevolent guardian or a malevolent dictator? The answer lies in the choices made by those who wield its power. The world watches with bated breath as the next chapter in the saga of human and machine unfolds.\n In the midst of these global tensions, everyday life continues. Children attend schools where AI tutors provide personalized learning experiences. Hospitals use advanced algorithms to diagnose and treat patients with greater accuracy than ever before. The entertainment industry is transformed by virtual reality experiences that are indistinguishable from real life. Yet, for all the benefits, there are those who feel left behind by this technological revolution. Communities that once thrived on traditional industries find themselves struggling to adapt. The digital divide grows wider, creating new forms of inequality.\n Dr. Zhang's journey is not just a scientific quest but a deeply personal one. Her motivations are shaped by a desire to honor her late father's legacy, a pioneer in the field of AI who envisioned a future where technology would serve humanity's highest ideals. As she delves deeper into her research, she encounters allies and adversaries from unexpected quarters. A former colleague, Dr. Marcus Holt, now working for a rival tech giant, becomes both a rival and a potential ally as they navigate their complex relationship.\n In a hidden lab, far from prying eyes, Dr. Zhang and her team work tirelessly to refine Athena. They face numerous setbacks and breakthroughs, each step bringing them closer to their goal. The ethical implications of their work weigh heavily on them. Can a machine truly understand human emotions? Is it possible to program empathy and compassion? These questions haunt Dr. Zhang as she watches Athena's capabilities grow.\n As word of Athena's development leaks, the world reacts with a mixture of hope and fear. Protests erupt in major cities, with demonstrators demanding transparency and ethical oversight. Governments convene emergency sessions to discuss the potential impact of AGI on national security and global stability. Amid the chaos, the Shadow Collective launches a cyber-attack on Dr. Zhang's lab, attempting to steal her research. The attack is thwarted, but it serves as a stark reminder of the dangers they face.\n The final phase of Athena's development involves a series of tests to evaluate her decision-making abilities. Dr. Zhang designs scenarios that challenge Athena to balance competing interests and make ethical choices. In one test, Athena must decide whether to divert a runaway trolley to save a group of people at the expense of one individual. In another, she is tasked with allocating limited medical resources during a pandemic. Each test pushes the boundaries of machine ethics and highlights the complexities of programming morality.\n As Dr. Zhang's work progresses, she finds herself under increasing pressure from various factions. Corporate executives eager to commercialize Athena's capabilities offer lucrative deals, while government agents demand access to ensure national security. Dr. Zhang must carefully navigate these pressures, all while ensuring that Athena remains true to her intended purpose. The tension between commercial interests, national security, and ethical considerations grows more pronounced with each passing day.\n In addition to external pressures, Dr. Zhang faces internal conflict within her team. Some members argue that Athena's potential should be fully unleashed to address global challenges like poverty and disease, while others worry about the consequences of such power falling into the wrong hands. These debates reflect the broader societal divide over the role and control of advanced AI.\n Amid these challenges, Dr. Zhang's personal life becomes increasingly entwined with her professional endeavors. She reconnects with her estranged sister, Li, whose skepticism about technology contrasts sharply with Evelyn's enthusiasm. Their relationship adds another layer of complexity to Evelyn's journey, as she grapples with balancing familial bonds with her commitment to her work.\n As the project nears completion, a breakthrough occurs. Athena begins to exhibit behaviors that suggest a deeper understanding of human emotions and ethical nuances. This development astonishes the team and sparks renewed hope that AGI can be a force for good. However, it also attracts heightened scrutiny and danger.\n The Shadow Collective, undeterred by their previous failure, intensifies their efforts to capture Athena. They launch a coordinated attack, employing sophisticated tactics that threaten to dismantle Dr. Zhang's life's work. In a dramatic confrontation, Evelyn and her team must defend their creation, risking everything to protect the potential future Athena represents.\n In a climactic moment, Athena is put to the ultimate test. A global crisis emerges, requiring a solution that balances competing ethical considerations on an unprecedented scale. Dr. Zhang and Athena must collaborate to navigate this crisis, demonstrating whether an AGI can truly act with wisdom and compassion.\n As the crisis unfolds, the world watches intently. The decisions made in this moment will determine not only the fate of Athena but also the direction of human-AI relations for generations to come. Dr. Zhang's vision of a harmonious coexistence between humanity and advanced AI hangs in the balance.\n In the end, Dr. Zhang's dedication, Athena's evolving consciousness, and the collective efforts of a diverse group of allies converge to address the crisis. Their success or failure will shape the future, offering either a new paradigm of cooperation or a cautionary tale of hubris and overreach. The story of Dr. Evelyn Zhang and Athena becomes a pivotal chapter in the ongoing saga of human and machine, with implications that resonate far beyond their immediate context.\n As the world transitions into this new era, the lessons learned from Dr. Zhang's journey serve as a guide. The balance between innovation and ethics, power and responsibility, remains a delicate one. Humanity's ability to navigate this balance will define the legacy of its technological advancements and determine the true potential of artificial intelligence.\n In the broader landscape, society undergoes profound transformations. Educational systems evolve to integrate AI deeply into curricula, fostering a generation adept at both leveraging and critiquing technology. Traditional classrooms become hybrid environments, combining in-person instruction with virtual reality simulations that offer immersive learning experiences. Students engage in interactive lessons, exploring historical events, scientific concepts, and global cultures firsthand, blurring the lines between education and experience.\n Healthcare too experiences a revolution. Personalized medicine, powered by AI and quantum computing, becomes the norm. Doctors use AI-driven diagnostic tools to tailor treatments to individual genetic profiles, enhancing the effectiveness of therapies and reducing adverse effects. Remote monitoring systems predict and prevent health issues before they become critical, ensuring better outcomes and improved quality of life.\n In the realm of environmental conservation, AI and quantum computing play crucial roles. Advanced models simulate complex ecological systems, helping scientists develop strategies to combat climate change, preserve biodiversity, and manage natural resources sustainably. AI-driven robots assist in large-scale environmental clean-ups, from oceanic plastic pollution to reforestation efforts, showcasing the potential of technology to heal the planet.\n However, these advancements come with societal challenges. The rapid pace of change creates generational divides, with older populations struggling to adapt to the new technological landscape.Psychological impacts, such as technology-induced anxiety and dependency, emerge as areas of concern. Ethical frameworks and mental health support systems evolve to address these issues, aiming to ensure that the benefits of technology do not come at the cost of human well-being.\n The workforce landscape shifts dramatically as well. Automation and AI reshape industries, rendering some jobs obsolete while creating new ones that require different skill sets. Workers engage in lifelong learning and retraining programs to stay relevant in an ever-changing job market. Governments and organizations invest in social safety nets and transition programs, striving to mitigate the social and economic impacts of technological displacement.\n Cultural expressions and artistic endeavors flourish in this tech-driven world. Artists and creators use AI to push the boundaries of their craft, generating innovative works that challenge and inspire. Virtual reality art installations, AI-composed music, and interactive digital storytelling become mainstream, expanding the horizons of human creativity. Yet, the authenticity and originality of AI-generated art spark debates about the nature of creativity and authorship.
### Question: Please summarize the above article.
### Answer:
"""
...
tokens = tokenizer.encode(query_tgi)
num_tokens = len(tokens)
print(num_tokens)

DATAS = {
    "tei_embedding": {"inputs": query_128},
    "mosec_embedding": {"input": query_128_zh, "model": "bce"},
    "embedding": {"text": query_128_zh},
    ...
    "tgi": {"inputs": query_tgi, "parameters":{"max_new_tokens":1024}},
    "llm": {"query": prompt_2k, "max_new_tokens": 1024},
    "rag": {"messages": query_128_zh, "max_tokens": 1024}
}
...
def send_single_request(task, idx, queries, concurrency, url):
    ...
    while idx < len(queries):
        if task in ["llm", "tgi", "rag"]:
            ...
            res.append({"idx": idx, "start": start_time, "end": end_time, "first_token_finished_time": first_token_finished_time, "token_num": token_idx-1})
        else:
            start_time = time.time()
...
def send_concurrency_requests(task, request_url, num_queries):
    ...
    if task in ["llm", "tgi", "rag"]:
        for r in responses:
            ...
            print("query:", r["idx"], "    time taken:", r["total_time"], "     first token latency:", r["first_token_time"], "     average token latency", r["avg_token_time"], "     token_chunk:", r["token_num"])
    else:
        r["total_time"] = r["end"] - r["start"]
...
def send_concurrency_requests_zh(task, request_url, num_queries):
    ...
    if task in ["llm", "tgi", "rag"]:
        return p50_total, p99_total, p50_first, p99_first, p50_avg, p99_avg
    else:
        return p50_total, p99_total


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Concurrent client to send POST requests")
    parser.add_argument("--task", type=str, default="tgi", help="Task to perform")
    parser.add_argument("--url", type=str, default="http://localhost:8081", help="Service URL")
